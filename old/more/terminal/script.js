...
const spotify_username = 'JoshIsYes'; 
const apiKey = '152dd7341991a250c5e0b7092879abd9';    
const apiUrl = `https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=${spotify_username}&api_key=${apiKey}&format=json&limit=1`;
const githubUsername = 'i-suck-at-most-stuff';  
const githubApiUrl = `https://api.github.com/users/${githubUsername}/events/public`;
let username = "Please_Enter_Your_Name";
...
function handleUsernameInput(e) {
    if (e.key === 'Enter') {
        username = input.value.trim() || "Please_Enter_Your_Name";
        prompt.textContent = `C:\\Users\\${username}>`;
        input.value = '';
